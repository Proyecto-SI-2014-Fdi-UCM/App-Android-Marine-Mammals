...
public class Fragment_Calculator extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		TextView results = (TextView)rootView.findViewById(R.id.textview_title_results);
		results.setTypeface(Typeface.SANS_SERIF);
		
		TextView hint_results=(TextView)rootView.findViewById(R.id.textview_results);
		hint_results.setTypeface(Typeface.SANS_SERIF);
