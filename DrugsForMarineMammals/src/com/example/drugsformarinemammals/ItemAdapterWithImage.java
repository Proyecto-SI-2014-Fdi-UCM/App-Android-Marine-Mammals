...
public class ItemAdapterWithImage extends BaseAdapter {

	private Context context;
	private List<ItemWithImage> items;

	public ItemAdapterWithImage(Context context, List<ItemWithImage> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			rowView = inflater.inflate(R.layout.item_with_image, parent, false);
		}
